...
;
; Description:
;	パターンの表示(横16dot限定, 4色以内, 縦反転)
;
; Functions/Procedures:
;	void super_put_tiny_vrev( int x, int y, int num ) ;
;
; Parameters:
;	x,y	描画する座標
;	num	パターン番号
...
;	95/ 1/ 5 Initial: superptv.asm / master.lib 0.23
;
...
func SUPER_PUT_TINY_VREV	; super_put_tiny_vrev() {
	push	BP
	mov	BP,SP
	push	DS
	push	SI
